...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TEAM-DOWN-TODAY/Lily2.0_Repo",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AXEL_POWERS")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Axel_ki_duniya")
